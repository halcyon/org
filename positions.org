...
| SHORT |  -1 | EFA    | 21 JUL |     66 | CALL |
*** Credit
    - 0.51 Cr. <2017-04-25 Tue>
    - 0.35 Cr. <2017-05-05 Fri> (Roll up put 61->64)
    - 0.17 Cr. <2017-06-12 Mon> (Roll call JUN->JUL)
** EWZ Iron Condor
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| LONG  |   1 | EWZ    | 21 JUL |     26 | PUT  |
| SHORT |  -1 | EWZ    | 21 JUL |     31 | PUT  |
| SHORT |  -1 | EWZ    | 21 JUL |     36 | CALL |
| LONG  |   1 | EWZ    | 21 JUL |     41 | CALL |
*** Credit
...
| SHORT |  -1 | FXE    | 21 JUL |    108 | CALL |
*** Credit
    0.47 Cr. <2017-05-10 Wed>
    0.27 Cr. <2017-05-17 Wed> (Roll up put 103->106)
    0.48 Cr. <2018-06-08 Fri> (Roll call JUN->JUL)
** HD JUL Call
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
...
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | ICE    | 21 JUL |     65 | CALL |
*** Credit
    - 0.45 Cr. <2017-06-07 Wed>
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | ICE    | 15 DEC |     70 | CALL |
*** Credit
    - 0.85 Cr. <2017-06-07 Wed>
** LULU Put
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | LULU   | 21 JUL |     50 | PUT  |
*** Credit
...
| SHORT |  -1 | MCD    | 15 SEP |    145 | CALL |
| LONG  |   1 | MCD    | 21 JUL |    150 | CALL |
*** Credit
    - 5.02 Cr. <2017-05-17 Wed>
    - 1.28 Cr. <2017-05-31 Wed> (Roll short 145 call JUL->SEP)
** MCD JUN Strangle
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | MCD    | 16 JUN |    145 | PUT  |
| SHORT |  -1 | MCD    | 15 DEC |    135 | CALL |
*** Credit
...
*** Credit
    ...
    - 0.99 Cr. <2017-06-07 Wed> (Roll out call JUN->JUL)
** NAT
*** Cost Basis
    - 10.5677
*** Put
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -2 | NAT    | 21 JUL |      7 | PUT  |
**** Credit
    - 0.50 Cr. <2017-05-16 Tue>
    - 0.30 Cr. <2017-05-16 Tue>
    - 0.20 Cr. <2017-06-12 Mon> (Roll JUN->JUL)
...
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | SLB    | 21 JUL |     70 | PUT  |
**** Credit
    - 0.89 Cr. <2017-04-24 Mon>
    - 1.11 Cr. <2017-06-09 Fri>
*** Put
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | SLB    | 21 JUL |   72.5 | PUT  |
**** Credit
    - 1.51 Cr. <2017-04-24 Mon>
    - 0.66 Cr. <2017-06-09 Fri>
...
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | WFM    | 18 AUG |     37 | PUT  |
| SHORT |  -1 | WFM    | 18 AUG |     31 | CALL |
*** Credit
    ...
    - 0.85 Cr. <2017-06-07 Wed> (Roll out put JUN->AUG)
    - 0.28 Cr. <2017-06-12 Mon> (Roll out call JUN->AUG)
    - Looking for a scratch, close at 5.20 Db.
** WMT Big Lizard
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
...
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| LONG  |   1 | KMX    | 16 JUN |   57.5 | PUT  |
| SHORT |  -1 | KMX    | 16 JUN |     60 | PUT  |
| SHORT |  -1 | KMX    | 16 JUN |     65 | CALL |
| LONG  |   1 | KMX    | 16 JUN |   67.5 | CALL |
*** Credit
    0.64 Cr. <2017-06-02 Fri>
** KRE Iron Condor
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| LONG  |   1 | KRE    | 21 JUL |     48 | PUT  |
| SHORT |  -1 | KRE    | 21 JUL |     50 | PUT  |
| SHORT |  -1 | KRE    | 21 JUL |     55 | CALL |
| LONG  |   1 | KRE    | 21 JUL |     57 | CALL |
*** Credit
    0.68 Cr. <2017-06-02 Fri>
** OIH Iron Condor
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
...
*** Credit
    ...
    - 10.50 Db. <2017-06-01 Thu> (Bought back call spread)
** SLB Put
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
...
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| LONG  |   1 | TLT    | 21 JUL |    119 | PUT  |
| SHORT |  -1 | TLT    | 21 JUL |    122 | PUT  |
| SHORT |  -1 | TLT    | 21 JUL |    129 | CALL |
| LONG  |   1 | TLT    | 21 JUL |    132 | CALL |
*** Credit
    0.79 Cr. <2017-06-02 Fri>
** V Iron Condor
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
...
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| SHORT |  -1 | X      | 21 JUL |     23 | PUT  |
*** Credit
    - 0.91 Cr. <2017-04-27 Thu>
    - 0.54 Cr. <2017-05-02 Tue> (Roll MAY->JUN)
    - 0.72 Cr. <2017-06-08 Thu> (Roll JUN->JUL)
** XOM Iron Condor
| Side  | Qty | Symbol | Exp    | Strike | Type |
|-------+-----+--------+--------+--------+------|
| LONG  |   1 | XOM    | 16 JUN |        | PUT  |
