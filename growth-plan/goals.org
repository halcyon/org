...
* Todo List [55/84]
** Todo [0/27]
*** STARTED https://sourcemaking.com/design_patterns
*** STARTED http://mishadoff.com/blog/clojure-design-patterns/
*** STARTED [[http://hrsoft.rentpath.com][self-eval]]
*** TODO [[http://lispcookbook.github.io/cl-cookbook/][Common Lisp Cookbook]]
*** TODO [[http://clojure.org/reference/multimethods][Multimethods and Hierarchies]]
